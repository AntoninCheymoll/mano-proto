...
export default function graphs(can, res, ctx, tps3, selectedGraph, colorSliderGraphs, isDraging) {
  ...
  for (let classe of res.phrases) {
      ...
      for (let classe2 of Object.keys(res.model.classes)) {
        ...
        if(classe2 == classeName){
          ...
          }else if(selectedGraph && selectedGraph[1]==classe.label && selectedGraph[0]==classe2) {
  ...
  recoMean = recoMean / res.model.classes.length;
